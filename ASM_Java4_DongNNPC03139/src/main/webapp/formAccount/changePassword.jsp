                        ...
                        <form action="#">
                            <div class="row">
                              <div class="col-lg-6  mx-auto mb-1">
                                <h4 class="mx-auto col-lg-12 mb-0">Đổi mật khẩu</h4>
                              <p class="font-italic text-muted"></p>
                               ...
                               <div class="input-group col-lg-9  mx-auto mb-4">
                                ...
                                <div class="input-group col-lg-9 mx-auto mb-4">
                                    ...
                                    <input id="password" type="password" name="password" placeholder="Nhập mật khẩu" class="form-control bg-white border-left-0 border-md">
                                </div>
                                ...
                                <div class="input-group col-lg-9  mx-auto mb-4">
                                    ...
                                    <input id="passwordConfirmation" type="text" name="passwordConfirmation" placeholder="Nhập lại mật khẩu" class="form-control bg-white border-left-0 border-md">
                                </div>
                                <!-- Submit Button -->
