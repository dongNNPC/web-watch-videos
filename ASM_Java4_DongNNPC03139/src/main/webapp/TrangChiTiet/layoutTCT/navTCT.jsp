...
<nav class="navbar navbar-expand-md navbar-light">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav ml-auto py-4 py-md-0">
			<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 active"></li>
			<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"><a
				class="nav-link" href="index#section-1">Anime</a></li>
			<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"><a
				class="nav-link" href="index#section-2">Phim lẻ</a></li>
			<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"><a
				class="nav-link" href="index#section-3">Phim bộ</a></li>
			<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"><a
				class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
				role="button" aria-haspopup="true" aria-expanded="false"> Coi
					nhiều nhất <i class="fa-solid fa-angle-down"></i>
			</a>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="luffy.jsp">One piece</a> <a
						class="dropdown-item" href="naruto.jsp">Naruto</a> <a
						class="dropdown-item" href="pokemon.jsp">Pokemon</a> <a
						class="dropdown-item" href="index#section-4">Tất cả</a>
				</div></li> &ensp; &ensp; &ensp; &ensp;
			<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"><a
				class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
