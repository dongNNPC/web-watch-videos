...
<body style=" background-color: #333; color: #ffffff;margin-top: 390px;">
    ...
    <main class="container">
        <div class="row">
            <div class="col-md-9">
                <iframe  width="850" height="400" style="border-radius: 20px;" src="https://www.youtube.com/embed/jZzpEUBj8vo"
                    title="Review Tử Tế : One Piece Red Flim" frameborder="0"
               ...
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#dialog2">
                ...
                <h5 style="text-align: justify;"> <br>
                    One Piece Film: Red xoay quanh sự xuất hiện của Monkey D. Luffy, thủ lĩnh của băng hải tặc Mũ Rơm đoàn tụ với người bạn thơ ấu đã mất tích từ lâu là Uta. Giờ cô đã là một ngôi sao nhạc Pop tài năng với lượng người hâm mộ đông đảo trên toàn thế giới.
                </h5>
