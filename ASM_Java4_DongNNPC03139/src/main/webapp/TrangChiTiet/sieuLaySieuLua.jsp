...
<head>
    <title>Phim Siêu lầy siêu lừa</title>
        ...
        <div class="row">
            <div class="col-md-9">
                <iframe width="850" height="400" style="border-radius: 20px;"
                    src="https://www.youtube.com/embed/EufgEvW-3pg"
                    title="REVIEW PHIM SIÊU LỪA GẶP SIÊU LẦY | Phim Hài Việt Liệu Đã Hay Hơn?" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>


                <h4>
                    REVIEW PHIM SIÊU LỪA GẶP SIÊU LẦY | Phim Hài Việt Liệu Đã Hay Hơn?
                </h4>
                <h6>
               ...
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#dialog2">
                ...
                <h5 style="text-align: justify;"> <br>
                    Truyện xoay quanh một cậu thám tử trung học có tên là Kudo Shinichi trong lúc đang điều tra một Tổ
                    chức Áo đen bí ẩn đã bị ép phải uống một loại thuốc độc có thể gây chết người. May mắn là cậu đã
                    sống sót nhưng cơ thể thì lại bị teo nhỏ như một đứa bé 6 tuổi
                </h5>
