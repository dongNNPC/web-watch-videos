...
<head>
    <title>Phim Những kẻ bị ruồng bỏ</title>
        ...
        <div class="row">
            <div class="col-md-9">
                <iframe width="850" height="400" style="border-radius: 20px;"
                    src="https://www.youtube.com/embed/xHohaypsufM"
                    title="Review truyện: Kẻ bị ruồng bỏ phần 1- Bi kịch của kẻ ngây thơ." frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                <h4>
                    Review truyện: Kẻ bị ruồng bỏ phần 1- Bi kịch của kẻ ngây thơ.
                </h4>
                <h6>
