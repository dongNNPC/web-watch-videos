        ...
        <div class="row">
            <div class="col-md-9">
                <iframe width="850" height="400" style="border-radius: 20px;"
                    ...
                    title="NHÀ BÀ NỮ - OFFICIAL TRAILER | Khởi chiếu mùng 1 Tết 2023" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                <h4>
                    NHÀ BÀ NỮ - OFFICIAL TRAILER | Khởi chiếu mùng 1 Tết 2023
                </h4>
                <h6>
                ...
                <h5 style="text-align: justify;"> <br>
                    Nhà bà Nữ là bộ phim tâm lý, tình cảm, khai thác đề tài về gia đình, xoay quanh chuyện đời thường
                    trong cuộc sống của gia đình bà Ngọc Nữ (Lê Giang). Ngoài tình cảm gia đình, phim còn lồng ghép
                    nhiều thông điệp về tình yêu đôi lứa, mâu thuẫn giữa con cái và cha mẹ thời hiện đạ
                </h5>
