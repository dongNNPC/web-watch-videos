...
<body style=" background-color: #333; color: #ffffff;margin-top: 390px;">
    ...
    <main class="container">
        <div class="row">
            <div class="col-md-9">
                <iframe  width="850" height="400" style="border-radius: 20px;" src="https://www.youtube.com/embed/xvz8T2LN4c8"
                    title="All in One || Trận Chiến Hay Nhất Chống lại Osutsuki Ishiki || Review anime Boruto"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
                <h4>
                    Trận Chiến Hay Nhất Chống lại Osutsuki Ishiki 
                </h4>
                <h6>
                ...
                <h5 style="text-align: justify;"> <br>
                    One Piece Film: Red xoay quanh sự xuất hiện của Monkey D. Luffy, thủ lĩnh của băng hải tặc Mũ Rơm
                    đoàn tụ với người bạn thơ ấu đã mất tích từ lâu là Uta. Giờ cô đã là một ngôi sao nhạc Pop tài năng
                    với lượng người hâm mộ đông đảo trên toàn thế giới.
                </h5>
